...
;   Version 0.13: September 24 2025 (added one function (remove-immediate-dup) in List Operations)
;      I also rearranged the order of the 'fill-library' alphabetically.
;   Version 0.14: April 13, 2026 (added one function (voice-interpolator) in List Operations)
;   Version 0.15: June 2, 2026 (added one function (voice-interpolator-with-grace) in List Operations)
;   Version 0.15.1: June 8, 2026 (renamed (voice-interpolator-with-grace) to (voice-interpolator-gn) in List Operations)
;   Version 0.16: June 11, 2026 (heavily revised voice-interpolator and voice-interpolator-gn)
;===============================================
...
(mapc 'om::compile&load 
      (list
       ...
       (make-pathname  :directory (append (pathname-directory *load-pathname*) (list "sources")) :name "voice-chord-seq-transformations" :type "lisp")
...
(om::fill-library 
 '(
   ("attractors and self-similarity operations" Nil Nil (1D-CELLULAR-AUTOMATA clifford dejong dejong-svensson lorenz mandelbrot-calc mandelbrot-imager ) Nil)
   ("euclid" Nil Nil (euclid-distance euclid-distance-3d euclid-rhythm-binary ) Nil)
   ("number operations" Nil Nil (keep-within-value ) Nil)
   ("list operations" Nil Nil (0to-1 -1to0 10->num num->10 bifurcate1 bifurcate2 bifurcate1-repeat bifurcate2-repeat chord-rotate converge1 converge2 converge1-repeat converge2-repeat fraction-maker listchomp remove-immediate-dup search-number-index ) Nil)
   ("Voice and Chord-seq transformations" Nil Nil (zigzag-chordseqtrace zigzag-chordseqtrace-v2 voice-interpolator voice-interpolator-gn ) Nil )
   ("number generators" Nil Nil (collatz srn zigzag-arithm-ser ) Nil)
   ))



(om::set-lib-release 0.14)
