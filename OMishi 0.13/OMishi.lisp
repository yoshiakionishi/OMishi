...
(om::fill-library 
 '(
   ...
   ("list operations" Nil Nil (0to-1 -1to0 10->num num->10 bifurcate1 bifurcate2 bifurcate1-repeat bifurcate2-repeat chord-rotate converge1 converge2 converge1-repeat converge2-repeat fraction-maker listchomp remove-immediate-dup search-number-index zigzag-chordseqtrace zigzag-chordseqtrace-v2 ) Nil)
